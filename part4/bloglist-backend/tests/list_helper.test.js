...
describe('total likes', () => {
  ...
  test('when list has 0 blogs, equals the likes of that', () => {
    const result = listHelper.totalLikes(blog_null)
...
describe('favorite blog', () => {
  ...
  test('when list has 0 blogs', () => {
    const result = listHelper.favoriteBlog(blog_null)
    assert.deepStrictEqual(result, {
      author: undefined,
      likes: -Infinity,
      title: undefined
...
describe('authorWithMostBlogs', () => {
  ...
  test('when list has 0 blogs', () => {
    const result = listHelper.authorWithMostBlogs(blog_null)
...
describe('authorWithMostLikes', () => {
  ...
  test('when list has 0 blogs', () => {
    const result = listHelper.authorWithMostLikes(blog_null)
    assert.deepStrictEqual(result, undefined)
  })
  test('when list has only one blog', () => {
